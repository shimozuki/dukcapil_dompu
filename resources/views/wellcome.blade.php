        ...
        <div class="row m-0">
            <div class="col-7 d-flex">
                <div class="row align-self-center">
                    <h1 class="text-bold" style="font-size: 50px;">SELAMAT DATANG DI LAYANAN <br /> DUKCAPIL DOMPU</h1>
...
<div class="w-screen py-5" style="background-color: #F6F6F6" id="profile">
    ...
    <div class="container my-5 px-5">
        <div class="visi d-flex flex-column align-items-center justify-content-center">
            ...
            <p class="text-lg text-center my-4">"Terwujudnya Dukcapil Dompu yang aman, sehat, cerdas, berbudaya, berakhlaq <br> mulia dan berdaya saing menuju pelayanan yang cepat dan tepat"</p>
        </div>
        <div class="misi d-flex flex-column align-items-center justify-content-center">
            ...
            <ol class="text-lg my-4">
                <li>Mewujudkan keamanan dan ketertiban di lingkungan Dukcapil Dompu.</li>
...
<div class="w-screen py-5 bg-green-pastel text-white" id="kontak">
    ...
    <div class="w-50 d-flex flex-column justify-content-center align-items-center mx-auto text-md">
        <p class="text-center my-3">Untuk informasi lebih lanjut terkait pelayanan Dukcapil Dompu <br> dapat menghubungi kontak dibawah ini :</p>
        <p><i class="fa fa-phone-alt"></i> : (0371) - 2311390</p>
        <p><i class="fa fa-envelope"></i> : dukcapilswq@sumbawakab.co.id</p>
    </div>
</div>
@endsection
