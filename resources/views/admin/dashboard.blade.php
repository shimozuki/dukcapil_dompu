...
@section('title', 'Dashboard | Dukcapil Dompu')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="jumbotron">
                        ...
                        <p class="lead">DOMPU NGAHI RAWI PAHU, Mewujudkan Masyarakat Dompu yang Mandiri, Adil, dan Sejahtera, berakhlak mulia dan berdaya saing menuju pelayanan pengaduan yang cepat dan tepat</p>
                        <hr class="my-4">
                        <p>Hallo, {{ auth()->user()->name }} Pelayanan</p>
                    </div>
                </div>
            </div>
        </div>
